...
## Project Structure
    ...
    ├── testrevertedfix_dev_32620  # Django project configurations
...
1. Clone this repo and `cd testrevertedfix_dev_32620`
...
2. Clone this repo and `cd testrevertedfix_dev_32620`
